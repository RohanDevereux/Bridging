...
% Front Matter
\title{Bridging Simulation and Experiment with
Deep Neural Networks for Estimating
Protein-Protein Binding Affinity}

\author{Rohan Devereux}

\degree{BSc Applied and Computational Mathematics}

\college{Science}
\school{School of Mathematics and Statistics\\and\\School of Physics}

\supervisor{Dr. Donal MacKernan (UCD)\\& Dr. Jony Castagna (STFC CECAM-UK-DARESBURY)}
