...
\end{equation}
All rankings and factor comparisons below are based on these configuration-level means. For matched design comparisons, the chapter reports the mean paired effect size together with the number of pairings favoring one design over the other.
